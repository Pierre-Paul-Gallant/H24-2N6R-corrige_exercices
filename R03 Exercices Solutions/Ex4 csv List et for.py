...
with open(ficher_a_lire,"r",encoding="utf-8") as csv_offres_emploies:
    csv_reader = csv.reader(csv_offres_emploies,delimiter=";")
    next(csv_reader)
    for offre in csv_reader:
        if offre[-2] in ["Dec", "Non déterminé"]:
            print(offre)
